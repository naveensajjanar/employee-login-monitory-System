...
public class AdminReg extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Admin adm=new Admin(Admin_id,first_name, last_name, DOB, Gender, Jooining_Date, Email, Official_email, Designation, Address, city, State, Country, Pin_code, Phone_no, Mobile_no, Area_of_work, Secret_question, Secret_Answer, Username, Password);
		AdminRegDao Admdao=new AdminRegDao();
		String result = " ";
		try {
			result = Admdao.Adminregister(adm);
		}
