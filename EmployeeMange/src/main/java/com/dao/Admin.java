...
public class Admin {
	...
	public Admin(String admin_id, String first_name, String last_name, String dOB, String gender, String jooining_Date,
			...
			String secret_question, String secret_Answer, String username, String password) {
